...
enabling users to run their own nodes to offer services to anyone they peer with. Each node acts as a gateway
to the entire network, allowing users to collaborate and benefit financially from it's use.
